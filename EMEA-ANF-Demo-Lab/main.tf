...
resource "azurerm_resource_group" "rg_1" {
  name     = "${var.use}-${var.prefix}-${var.geo}-${var.region_1}-${random_string.rg_random_1.result}"
...
resource "azurerm_resource_group" "rg_2" {
  name     = "${var.use}-${var.prefix}-${var.geo}-${var.region_2}-${random_string.rg_random_2.result}"
